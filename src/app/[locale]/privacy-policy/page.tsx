...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: 'Privacy Policy - Guide to Adopting Humans Wiki',
    description: 'Guide to Adopting Humans Wiki Privacy Policy. Learn how we collect, use, and protect your data when you use our fan-made fictional universe resource platform. Your privacy matters to us.',
    robots: {
      index: false,
      follow: true,
      googleBot: {
      ...
      <section className="py-12 px-4">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <p>
              Guide to Adopting Humans Wiki ("we", "our", or "us") collects minimal information to provide and improve our services.
            ...
            <p>
              Our website may contain links to external websites, including Reddit, YouTube, and other community platforms.
            ...
            <h2>11. Disclaimer</h2>
            <p>
              Guide to Adopting Humans Wiki is an unofficial fan-made website and is not affiliated with, endorsed by, or associated
              with any real game developer, publisher, or brand. All fictional content, trademarks, and assets are
            ...
            <p>
              <strong>Email:</strong> <a href="mailto:privacy@guidetoadoptinghumans.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">privacy@guidetoadoptinghumans.wiki</a>
            </p>
            <p>
