...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: "Terms of Service - Guide to Adopting Humans Wiki",
    description: "Read the Terms of Service for Guide to Adopting Humans Wiki. Learn about user responsibilities, content usage guidelines, and legal terms for using our fan-made fictional universe resource platform.",
    robots: {
      index: false,
      follow: true,
      googleBot: {
    ...
    openGraph: {
      ...
      title: "Terms of Service - Guide to Adopting Humans Wiki",
      description: "Terms and conditions for using Guide to Adopting Humans Wiki.",
      images: [
        {
      ...
      <section className="relative py-20 px-4 border-b border-border">
        <div className="container mx-auto max-w-4xl text-center">
          ...
          <p className="text-slate-300 text-lg mb-2">
            Terms and conditions for using Guide to Adopting Humans Wiki
          </p>
      ...
      <section className="py-12 px-4">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <p>
              By accessing and using Guide to Adopting Humans Wiki ("the Website", "we", "our", or "us"), you agree to be bound
              by these Terms of Service ("Terms"). If you do not agree to these Terms, please do not use our Website.
            </p>
            <p>
              These Terms constitute a legally binding agreement between you ("User", "you", or "your") and Guide to Adopting Humans Wiki.
              Your continued use of the Website signifies your acceptance of these Terms and any future modifications.
            </p>

            <h2>2. Description of Service</h2>
            <p>
              Guide to Adopting Humans Wiki is an unofficial, community-driven fan website that provides information, guides, tools,
              and resources related to the fictional "Guide to Adopting Humans" universe. Our services include, but are not limited to:
            </p>
            <ul>
              <li>Adoption process and eligibility guides</li>
              <li>Human traits and care guides</li>
              <li>Alien species compatibility references</li>
              <li>Characters, lore, and locations encyclopedia</li>
              <li>Beginner walkthroughs and tips</li>
              <li>Community discussion and content</li>
            </ul>
            <p>
              <strong>Important:</strong> Guide to Adopting Humans Wiki is NOT affiliated with, endorsed by, or associated with
              any real game developer, publisher, or brand. We are an independent fan community.
            </p>
            ...
            <p>
              ...
              graphics, logos, images, and software) are owned by Guide to Adopting Humans Wiki and are protected by international
              copyright, trademark, and other intellectual property laws.
            </p>

            <h3>4.2 Referenced Third-Party Content</h3>
            <p>
              Any referenced third-party materials (such as educational videos, community discussions, or external
              links) remain the property of their respective owners. &quot;Guide to Adopting Humans&quot; is a fictional
              concept, and all original lore on this website is created by Guide to Adopting Humans Wiki. We use
              third-party content under fair use principles for informational and educational purposes only.
            </p>
            ...
            <ul>
              <li><strong>Accuracy:</strong> We strive to provide accurate information, but we do not guarantee that all content is current, complete, or error-free. As a fictional universe guide, content may evolve over time.</li>
              ...
              <li><strong>Fictional Content:</strong> "Guide to Adopting Humans" is a fictional concept. All lore, characters, and scenarios are imaginary and presented for entertainment and creative exploration.</li>
            </ul>
            <p>
            ...
            <p>
              TO THE FULLEST EXTENT PERMITTED BY LAW, GUIDE TO ADOPTING HUMANS WIKI SHALL NOT BE LIABLE FOR ANY INDIRECT, INCIDENTAL,
            ...
            <p>
              The Website may contain links to third-party websites, including Reddit, YouTube, and other community platforms,
            ...
            <p>
              ...
              you and Guide to Adopting Humans Wiki regarding the use of the Website and supersede any prior agreements or understandings.
            </p>
            ...
            <p>
              <strong>Email:</strong> <a href="mailto:legal@guidetoadoptinghumans.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">legal@guidetoadoptinghumans.wiki</a>
            </p>
            <p>
